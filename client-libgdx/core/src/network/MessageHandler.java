            ...
            try {
                ...
                switch (msg.command) {
                    ...
                    case 3: {
                        ...
                        // Hybrid Java server (2.3-compatible wire format) starts LOGIN_SUCCESS
                        // directly with user_id. The upstream 2.4 desktop source used server==2
                        // to read an extra UTF username here; doing that against Hybrid shifts the
                        // entire packet and causes login to hang in the wait dialog.
