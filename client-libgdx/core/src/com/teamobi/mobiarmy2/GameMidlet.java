...
public class GameMidlet extends MIDlet implements IActionListener {
    ...
    public static String IP = HybridConfig.host();
    public static int PORT = HybridConfig.gamePort();
    ...
    public static String linkGetHost = HybridConfig.serverListUrl();
    public static String linkReg = HybridConfig.registrationUrl();
    ...
    private void initGame2() {
        ...
        // Desktop Hybrid builds always start from the configured private endpoint.
        // Old RMS/server-list values must never silently redirect the client to legacy public servers.
        GameMidlet.IP = HybridConfig.host();
        PORT = HybridConfig.gamePort();
        linkGetHost = HybridConfig.serverListUrl();
        linkReg = HybridConfig.registrationUrl();
    ...
    public static void doUpdateServer() {
        ...
        getServerList(HybridConfig.serverListEntries());
        saveIP();
