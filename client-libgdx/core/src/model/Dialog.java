...
public abstract class Dialog {
   ...
   /**
    * Desktop/J2ME soft-key bridge. Dialogs in the original source only
    * dispatched commands from pointer release, so keyboard OK worked on a
    * screen and then appeared dead as soon as a MsgDlg was shown.
    */
